...
import 'package:airlogin/components/welcome.dart';
                ...
                child: MaterialButton(
                  onPressed: () async {
                    ...
                    if (istrue == false) {
                      ...
                      final List<Flights> allflights = await getAllFlights();
                      context.read<TimsProvider>().addAllFlights(allflights);
